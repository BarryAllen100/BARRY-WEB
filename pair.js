...
router.get('/', async (req, res) => {
    ...
    async function qr() {
        ...
        if (pairingCode && !XeonBotInc.authState.creds.registered) {
            ...
            if (phoneNumber) {
                ...
                if (!Object.keys(PHONENUMBER_MCC).some(v => phoneNumber.startsWith(v))) {
                    return res.status(400).send("Commencez par le code du pays de votre numéro WhatsApp, exemple : +242067274660");
                }
            } else {
                phoneNumber = await question(chalk.bgBlack(chalk.greenBright("Veuillez saisir votre numéro WhatsApp 🩵\nPar exemple : +242067274660 : ")));
                phoneNumber = phoneNumber.replace(/[^0-9]/g, '');
        ...
        XeonBotInc.ev.on("connection.update", async (s) => {
            ...
            if (connection === "open") {
                await delay(10000);
                await XeonBotInc.sendMessage(XeonBotInc.user.id, { text: `┏━『 *BARRY-MD* 』━◧
┣⌬ *SESSION = CONNECTÉ*
┣⌬ *CREDS.JSON = 📁✅*
┗━━━━━━━━━━━━━━━◧

━━━━━━━━━━━━━━━━━━━
❶ || 𝐆𝐢𝐭 = 🌐 https://github.com/BarryAllen100/BARRY-BUG-BOT
━━━━━━━━━━━━━━━━━━━
❷ || 𝐆𝐫𝐨𝐮𝐩𝐞 = 🪀 https://chat.whatsapp.com/IdB2EfQiNlKBekQrigN9m9
━━━━━━━━━━━━━━━━━━━
❸ || 𝐂𝐡𝐚𝐢𝐧𝐞 𝐖𝐡𝐚𝐭𝐬𝐀𝐩𝐩 = 🪀 https://whatsapp.com/channel/0029Vajrhmz96H4IsEjh4a41
━━━━━━━━━━━━━━━━━━━
➡️ 𝐒𝐮𝐢𝐯𝐞𝐳 𝐦a 𝐂𝐡𝐚𝐢𝐧𝐞 𝐝𝐞 𝐒𝐮𝐩𝐩𝐨𝐫𝐭

📞 𝐕𝐨𝐮𝐬 𝐯𝐨𝐮𝐥𝐞𝐳 𝐦𝐞 𝐩𝐚𝐫𝐥𝐞𝐫 ? 👉 https://Wa.me//+242067274660 👈
━━━━━━━━━━━━━━━━━━━

© 2024-2099 *Barry allen*` });
